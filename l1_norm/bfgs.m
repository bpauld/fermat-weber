function [x,nbIt,stopping_cond] = bfgs(A,omega,x0,c1,c2,eps1,eps2)
...
%output stopping_cond : 1 if stops because norm(gradient) < eps1
%                       2 if norm( x(k+1) - x(k) ) < eps2
